...
const buttonStyle =
  "px-0 py-2 border-r-[1px] border-b-[1px] first-of-type:border-l-[1px] border-gray-200 flex-1 text-lg bg-slate-400 bg-opacity-20 active:bg-opacity-40 hover:bg-opacity-40";
